...
double GaussianQuadrature::integrate(std::function<double(int, double)> func1, int n_func1, std::function<double(int, double)> func2, int n_func2, std::function<double(int, double)> func3, int n_func3,
