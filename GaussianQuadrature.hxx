...
public:
    ...
    static double integrate(std::function<double(int, double)> func1, int n_func1, Matrix alpha, double vx, double vy, double vz, int lMax, int quadratureOrder, Vector roots, Vector weights);
